...
class FamiliSurveyHomeScreen extends StatefulWidget {
  @override
  _FamiliSurveyHomeScreenState createState() => _FamiliSurveyHomeScreenState();
}

class _FamiliSurveyHomeScreenState extends State<FamiliSurveyHomeScreen> {
  ...
  List<NeedAssessmentData> surveys = [
    ...
    NeedAssessmentData()
      ...
      ..members = [
        Member(name: "Member 1.1", age: "30", gender: "Male", relationship: "Father"),
        Member(name: "Member 1.2", age: "25", gender: "Female", relationship: "Mother"),
      ],
    // Sample Data 2
    NeedAssessmentData()
      ...
      ..members = [
        Member(name: "Member 2.1", age: "50", gender: "Male", relationship: "Head"),
      ],
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Need Assessment Surveys'),
      ),
      body: surveys.isEmpty
          ? Center(
              child: Text('No surveys saved yet.'),
            )
          : ListView.builder(
                  ...
                  child: ListTile(
                    title: Text(
                        surveys[index].householdHead.isNotEmpty
                            ...
                            : 'Survey ${index + 1}'), // Display household head or a default name
                    subtitle: Text('Village/Ward: ${surveys[index].villageWard}'),
                    onTap: () {
  ...
  void _editSurvey(NeedAssessmentData surveyData) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => ScreenA(data: surveyData),
      ),
    ).then((value) {
      // This 'then' block is important!
      // It's executed when we come back from ScreenA (or any edit screen).
      setState(() {
        // We call setState to rebuild the FamiliSurveyHomeScreen and reflect any changes
